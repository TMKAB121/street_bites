...
<head>
    ...
    <title>A truck claim is awaiting review</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px; background:#ffffff; border-radius:12px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px 24px;">
                            <h1 style="margin:0 0 8px; font-size:20px; color:#1e2229;">A truck claim is awaiting review</h1>
                            <p style="margin:0 0 20px; font-size:15px; line-height:1.5; color:#636e72;">
                                Someone asked to take ownership of an unclaimed truck. Approving
                                transfers the listing to them so they can edit it.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px; font-size:14px; color:#2d3436;">
                                ...
                                <tr>
                                    <td style="padding:6px 0; color:#636e72;">Claimant</td>
                                    <td style="padding:6px 0;">{{ $claimantEmail }}</td>
                                </tr>
                                @if ($message)
                                    <tr>
                                        <td style="padding:6px 0; color:#636e72;">Message</td>
                            ...
                            <div style="text-align:center; margin:0 0 8px;">
                                <a href="{{ $reviewUrl }}" style="display:inline-block; background:#ffc700; color:#1e2229; font-size:15px; font-weight:bold; text-decoration:none; border-radius:10px; padding:14px 28px;">Review the claim</a>
                            </div>
                        </td>
                    </tr>
                </table>
